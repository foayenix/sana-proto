...
// using system fonts to avoid network font fetches during demos
...
class AppTheme {
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      // Use a static TextTheme based on the system fonts so the demo doesn't require downloading Google Fonts.
